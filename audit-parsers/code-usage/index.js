...
var process = () => {
    var promise = new Promise((resolve, reject) => {
        ...
        var fileName = path.join(__dirname, "results-2023.csv");   

        FileLoader.loadFileWithInstancesAndAccounts(fileName).then((auditData) => {

            var wb = new Audit.AuditWorkbook("code-usage-results-2023.xlsx");
...
var processCustomerCreated = () => {
    var promise = new Promise((resolve, reject) => {
        ...
        FileLoader.loadFileWithInstancesAndAccounts(fileName).then((auditData) => {
            ...
            var wb = new Audit.AuditWorkbook("code-usage-customer-2023.xlsx");
