                ...
                if(row.data && row.data.experiences) {
                    ...
                    for(var id in row.data.experiences) {
                        ...
                        var experience = {
                            ...
                            scope: ex.scope,
                            createdOn: ex.cDate,
                            createdOnMonthYear: moment(ex.cDate).format("YYYY-MM"),
                            createdOnQtr: `${moment(ex.cDate, "YYYY-MM").format("YYYY")}-Q${moment(ex.cDate, "YYYY-MM").quarter()}`,
                            updatedOn: ex.uDate,
                            updatedOnMonthYear: moment(ex.uDate).format("YYYY-MM"),
