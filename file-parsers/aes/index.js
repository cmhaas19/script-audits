                ...
                if(instance.settings) {
                    instance.settings.forEach(row => {
                        ...
                        if(row.data) {
                            ...
                            values.push(details.licensed, details.installed, details.installedOn, details.version, row.data.pipelineCount);
                ...
                if(instance.apps) {
                    instance.apps.forEach(row => {
                        if(row.data && row.data.customStoreApps) {
                            ...
                            for(var id in apps) {
                                var app = apps[id];
                                var isAESApp = !(customAESAppIds[id] == undefined);
